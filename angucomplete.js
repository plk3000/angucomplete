        ...
        link: function($scope, elem) {
            ...
            $scope.selectResult = function(result) {
                ...
                if ($scope.onSelection) {
                  $scope.onSelection({ result: result });
                }
                //$scope.$apply();
            };
